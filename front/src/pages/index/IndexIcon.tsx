...
export default function IndexIcon({ name }: { name: IndexIconName }) {
  ...
  const shapes: Record<IndexIconName, ReactNode> = {
    notifications: <><circle cx="24" cy="7" r="4" fill={metal}/><path d="M11 24c0-11 5-16 13-16s13 5 13 16v8l5 6H6l5-6z" fill={paint}/><path d="M19 41h10a5 5 0 0 1-10 0" fill={metal}/><path d="M15 24c0-6 2-10 6-12M10 35h28" {...details}/></>,
